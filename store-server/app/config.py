...
class Settings:
    ...
    repo_name: str = field(default_factory=lambda: _env("STORE_REPO_NAME", "OpenAP University Apps"))
    ...
    repo_keyalias: str = field(default_factory=lambda: _env("STORE_REPO_KEYALIAS", "openap"))
    key_dname: str = field(default_factory=lambda: _env("STORE_KEY_DNAME", "CN=OpenAP, O=OpenAP"))
